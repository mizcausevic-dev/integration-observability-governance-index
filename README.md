...
Integration Observability Governance Index is a Kinetic Gain benchmark-pack repo for enterprise platform and company signals.
...
`json
{
  "product": "Integration Observability Governance Index",
